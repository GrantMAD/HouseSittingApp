        ...
        >
            ...
            <div className="flex p-8">
                {approvedSitters.map(sitter => (
                    <div key={sitter.id} class="w-2/12 max-w-2/12 mr-10 bg-white dark:bg-gray-900 rounded-lg overflow-hidden shadow-md shadow-gray-600 border border-blue-700">
                        <div class="border-b px-4 pb-6">
                            <div class="text-center my-4">
                                <img class="h-32 w-32 rounded-full mx-auto my-4 border border-blue-700 shadow-xl"
                            ...
                            <div class="flex gap-2 px-2 w-1/2">
                                <Link
                                    class="flex-1 shadow-xl rounded-full bg-gradient-to-r from-green-400 via-cyan-900 to-blue-700 text-white dark:text-white antialiased font-bold hover:scale-110 px-4 py-2"
